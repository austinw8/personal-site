...
const TECH_STACK = {
	languages: {
		...
		items: [
			...
			{
				name: "SQL",
				logo: "/logos/sql_logo.png",
				enabled: true,
			},
			{
				name: "R",
				logo: "/logos/r_logo.png",
				enabled: true,
			},
			{
				name: "HTML",
				logo: "/logos/html_logo.png",
				enabled: true,
			},
			{
				name: "CSS",
				logo: "/logos/css_logo.png",
				enabled: true,
			},
		],
	},
	frameworks: {
		...
		items: [
			{
				name: "React",
				logo: "/logos/react_logo.png",
				enabled: true,
			},
			{
				name: "Next.js",
				logo: "/logos/nextjs_logo.png",
				enabled: false,
			},
			{
				name: "FastAPI",
	...
	tools: {
		...
		items: [
			...
			{
				name: "Git",
				logo: "/logos/git_logo.png",
				enabled: true,
			},
			{
				name: "GCP",
				logo: "/logos/gcp_logo.png",
				enabled: true,
			},
			{
				name: "DBeaver",
				logo: "/logos/dbeaver_logo.png",
				enabled: true,
			},
			{
				name: "Looker Studio",
